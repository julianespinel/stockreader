...
public class HistoricalPriceRowMapper implements RowMapper<HistoricalPrice> {

    @Override
    public HistoricalPrice mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        return new HistoricalPrice(symbol, date, open, close, high, low, volume,
